        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CustomeSurname = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    CustomerImageUrl = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    CustomeCity = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    CustomeDistrict = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    CustomeBalance = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    CreatedDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    IsActive = table.Column<bool>(type: "bit", nullable: false)
                },
